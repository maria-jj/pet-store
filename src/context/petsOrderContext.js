...
export const PetsOrderContextProvider = (props) => {
    ...
    const intializePets = (petsFromApi)=>{
    setPets(petsFromApi);
    }
    ...
    return (<PetsOrderContext.Provider
     value={{order: order, addPetToOrder: addPetToOrder, removePetFromOrder: removePetFromOrder, pets: pets, intializePets:  intializePets}}
    >
        {props.children}
